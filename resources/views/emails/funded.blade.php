...
<head>
    ...
    <style>
        ...
        .amount { font-size: 48px; color: #EFFF00; font-weight: bold; margin: 30px 0; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Wallet Funded!</h1>
            <p>Hello {{ $user->name }}, we're pleased to inform you that your wallet has been funded.</p>
            <div class="amount">${{ number_format($amount, 2) }}</div>
            <p>Your new balance is <strong>${{ number_format($user->balance, 2) }}</strong>. You can use these funds to purchase any tools or services on our platform.</p>
            <a href="{{ config('app.url') }}/dashboard" class="button">View Balance</a>
        </div>
        <div class="footer">
